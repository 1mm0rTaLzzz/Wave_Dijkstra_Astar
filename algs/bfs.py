...
def get_click_mouse_pos():
    ...
    pg.draw.rect(sc, pg.Color('green'), get_rect(grid_x, grid_y))
...
while True:
    ...
    [[pg.draw.rect(sc, pg.Color('darkorange'), get_rect(x, y))
    ...
    pg.draw.rect(sc, pg.Color('red'), get_rect(*start))
    pg.draw.rect(sc, pg.Color('green'), get_rect(*path_head))
